...
into the shared npz under 'rs8kc35-<iter>' — directly comparable to the re2k-599 card, isolating
...
CKS = sorted(glob.glob('monitoring/ddpo_re8000_rs_t35_ckpts/ddpo_re1000_iter*.pkl'))
