...
into the shared npz under 'rs2k-<iter>' — directly comparable to the re2k-599 card, isolating
...
CKS = sorted(glob.glob('monitoring/ddpo_re2000_realstats_ckpts/ddpo_re1000_iter*.pkl'))
