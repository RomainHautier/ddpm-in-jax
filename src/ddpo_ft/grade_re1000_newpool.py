...
CKDIR = 'monitoring/ddpo_re1000_newpool_ckpts'
POOLS = {'train': list(range(20, 28)), 'val': [32, 33, 34, 35]}
PER_SEQ = 20
...
np.savez('base_results/re1000_newpool_grading.npz', labels=np.array([l for l, _ in rows]),
